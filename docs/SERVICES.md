...
The worker runs in short batches. Free Edge Functions have 256 MB RAM, a 150-second worker limit, and two seconds actual CPU per request. The one-minute cron schedule, enabled September 23, 2026, is 44,640 worker invocations in a 31-day month before manual runs (calculation), within the free invocation allowance documented above. [Function limits](https://supabase.com/docs/guides/functions/limits), [Supabase scheduling](https://supabase.com/docs/guides/functions/schedule-functions).
