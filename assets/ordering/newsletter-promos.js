...
export function renderNewsletterPromos(promos,{money,escapeHtml:esc,dateTime,now=Date.now()}) {
  ...
  return `<section class="newsletter-promo-panel" aria-labelledby="newsletter-promos-title">
    <div class="section-heading"><div><h2 id="newsletter-promos-title">Newsletter welcome codes</h2><p class="muted">New subscribers receive a personal, single-use 5% code. Valid for 30 days · ₱300 minimum purchase · ₱100 maximum discount · Delivery excluded.</p></div><button class="button button-secondary" data-action="refresh">Refresh</button></div>
