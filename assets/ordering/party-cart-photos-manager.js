...
export function mountPartyCartPhotos(root, { role, connected, api, upload }) {
  ...
  root.addEventListener('click', async event => {
    ...
    try {
      ...
      paint(); message('Saved. The Party Carts page now uses these photos and this order.');
